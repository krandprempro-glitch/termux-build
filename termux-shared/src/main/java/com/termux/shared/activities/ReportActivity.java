package com.terlinux.shared.activities;
...
import com.terlinux.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.terlinux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.terlinux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
