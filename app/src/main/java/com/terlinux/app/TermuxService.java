...
import com.terlinux.shared.termux.shell.TermuxShellUtils;
...
import com.terlinux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.terlinux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.terlinux.shared.termux.shell.TermuxShellManager;
...
import com.terlinux.shared.notification.NotificationUtils;
...
import com.terlinux.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.terlinux.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.terlinux.shared.R.string.error_execution_cancelled))) {
