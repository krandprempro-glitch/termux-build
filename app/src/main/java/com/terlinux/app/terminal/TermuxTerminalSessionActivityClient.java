...
import com.terlinux.shared.termux.terminal.io.BellHandler;
import com.terlinux.shared.logger.Logger;
import com.terlinux.terminal.TerminalColors;
import com.terlinux.terminal.TerminalSession;
import com.terlinux.terminal.TerminalSessionClient;
import com.terlinux.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.terlinux/com.terlinux.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
